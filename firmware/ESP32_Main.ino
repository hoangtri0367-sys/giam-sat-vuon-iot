...
// ĐỌC ĐỘ ẨM ĐẤT
// ════════════════════════════════════════════════
// Mốc hiệu chuẩn thực tế đo được trên board (17/9/2026):
//   Khô (lau khô, để ráo)  : raw dao động 2370–2400  -> lấy 2400 làm mốc 0%
//   Ướt (ngâm ngập nước)   : raw dao động 810–830    -> lấy 810  làm mốc 100%
const int SOIL_RAW_DRY = 2400;
const int SOIL_RAW_WET = 810;
